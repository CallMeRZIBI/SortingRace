...
{
    public class InterativeMergeSort : Base
    {
        public InterativeMergeSort(int[] input) : base(input) {}
        ...
        public void sort(int[] arr, int n)
        {
            ...
            // Merge subarrays in bottom up manner. First merge subarrays of size 1 to create sorted subarrays
